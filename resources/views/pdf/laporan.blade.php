      ...
      <div style="margin-left:6rem;">
         <span class="text-header text-bold text-danger">
            PEMERINTAH DAERAH PROVINSI JAWA BARAT <br> DINAS PENDIDIKAN <br>
               ...
               SEKOLAH MENENGAH KEJURUAN NEGERI 4 BANDUNG <br>
         </span>
         <span class="text-desc">Jalan Kliningan Nomor 6 Telepon (022) 7303736<br>FAX (022) 7303736
          Website <span class="underline">www.smkn4bdg.sch.id</span> - Email <span class="underline">info@smkn4bdg.sch.id</span> <br> Turangga, Kec. Lengkong, Kota Bandung, Jawa Barat 40264<br> </span>
      </div>    
      </div>
   <div>
   <!-- /header -->
